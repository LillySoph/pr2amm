...
//		String filename = MethodHandles.lookup().lookupClass().getResource(name).getPath(); 
		...
		return fillArrayWithIntElementsFromFile(name);
...
//		String filename = MethodHandles.lookup().lookupClass().getResource(name).getPath(); 
		...
		return fillArrayWithStringElementsFromFile(name);
...
//		String filename = MethodHandles.lookup().lookupClass().getResource(name).getPath(); 
		...
		return fillArrayWithSongsFromFile(name);
